...
%%% Common data %%%
\newcommand{\thesisAuthorLastName}{Рыбьянов}
\newcommand{\thesisAuthorOtherNames}{Антон Валерьевич}
...
{Численный метод моделирования течений невязкого газа\\ с~использованием DG и~тетраэдральных сеток}
